...
function Emergencia() {
  return (
    <PhoneShell footer={<BottomNav />}>
      <AppHeader title="Emergência" />
      <div className="flex flex-1 flex-col gap-5 px-4 py-5">
        <button className="flex items-center gap-4 rounded-2xl bg-destructive px-5 py-5 text-left text-destructive-foreground shadow-float transition-transform active:scale-[0.98]">
          <span className="flex h-12 w-12 items-center justify-center rounded-full bg-white/20">
            <PhoneCall className="h-6 w-6" />
          </span>
          <span>
            <span className="block text-lg font-bold">SOS</span>
